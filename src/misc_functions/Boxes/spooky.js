...
╚━═━︽︾︽︾🎃︾︽︾︽━═━╝
◾`)
            if (loot[i_loot].name == `ХЭЛЛОУИНСКАЯ ДУША`) {
...
╚═════════♡════════╝`
            ...
            console.log(chalk.blackBright(`[${new Date()}]`) + chalk.magentaBright(`[${interaction.user.tag} открыл жуткую коробку]`) + chalk.gray(`: +${act_exp[i_act].amount} опыта активности, +${rank_exp[i_rank].amount} опыта рангов и ${loot[i_loot].name}`))
