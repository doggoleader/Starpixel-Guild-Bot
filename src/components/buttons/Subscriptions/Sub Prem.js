...
╚═════════♡════════╝`
        ...
        userData.cooldowns.premium = Date.now() + (1000 * 60 * 60 * 24 * 7) * (1 - (userData.perks.decrease_cooldowns * 0.1))
        if (userData.cd_remind.includes('premium')) {
            let ITEM_ID = userData.cd_remind.findIndex(item_id => item_id == 'premium')
