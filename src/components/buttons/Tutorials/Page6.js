...
После открытия коробки, весь ваш опыт активности будет отправляться в канал <#${ch_list.box}>. Он также считается автоматически и, чтобы посмотреть ваш опыт, пропишите ${mentionCommand(client, 'profile')}!`)
