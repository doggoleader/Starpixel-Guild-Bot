...
Если вы считаете, что это ошибка, напишите об этом в <#${ch_list.ask}>!`)
        ...
        if (userData.seasonal.easter.achievements.num3 === true) return interaction.reply({
            embeds: [already_done],
            ephemeral: true
        })
...
Если вы считаете, что это ошибка, напишите об этом в <#${ch_list.ask}>!`)
        ...
        if (userData.seasonal.easter.ea_cosm == false) return interaction.reply({
            embeds: [no_condition],
            ephemeral: true
        })
        ...
        userData.seasonal.easter.achievements.num3 = true
