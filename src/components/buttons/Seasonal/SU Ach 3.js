...
Если вы считаете, что это ошибка, напишите об этом в <#${ch_list.ask}>!`)
        ...
        if (userData.seasonal.summer.achievements.num3 === true) return interaction.reply({
            embeds: [already_done],
            ephemeral: true
        })
...
Если вы считаете, что это ошибка, напишите об этом в <#${ch_list.ask}>!`)
        ...
        if (userData.seasonal.summer.sea_ticket === false) return interaction.reply({
            embeds: [no_condition],
            ephemeral: true
        })
        ...
        userData.seasonal.summer.achievements.num3 = true
