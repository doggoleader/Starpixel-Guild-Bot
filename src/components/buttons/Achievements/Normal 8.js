...
Если вы считаете, что это ошибка, напишите об этом в <#${ch_list.ask}>!`)
        ...
        if (!member.roles.cache.has(`553637207911563264`) && !member.roles.cache.has(`553638061817200650`) && !member.roles.cache.has(`605696079819964426`) && !member.roles.cache.has(`553638054238093364`)) return interaction.reply({
            embeds: [no_condition],
            ephemeral: true
        })
