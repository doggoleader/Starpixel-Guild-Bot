...
async function execute(interaction, client) {
    try {
        ...
        let role = `585175188187119638`
        let name = `№17. Цвет настроения`
...
Если вы считаете, что это ошибка, напишите об этом в <#${ch_list.ask}>!`)
        ...
        if (!member.roles.cache.has(`595893144055316490`) && !member.roles.cache.has(`595892599693246474`) && !member.roles.cache.has(`595892677451710468`) && !member.roles.cache.has(`595892238370996235`) && !member.roles.cache.has(`589770984391966760`) && !member.roles.cache.has(`595893568485326862`) && !member.roles.cache.has(`630395361508458516`) && !member.roles.cache.has(`595892930204401665`) && !member.roles.cache.has(`595889341058777088`)) return interaction.reply({
            embeds: [no_condition],
            ephemeral: true
        })
