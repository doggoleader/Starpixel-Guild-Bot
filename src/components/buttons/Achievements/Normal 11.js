...
Если вы считаете, что это ошибка, напишите об этом в <#${ch_list.ask}>!`)
        ...
        if (!member.roles.cache.has(`930169143347523604`) && !member.roles.cache.has(`930169139866259496`) && !member.roles.cache.has(`930169133671280641`) && !member.roles.cache.has(`930169145314652170`)) return interaction.reply({
            embeds: [no_condition],
            ephemeral: true
        })
