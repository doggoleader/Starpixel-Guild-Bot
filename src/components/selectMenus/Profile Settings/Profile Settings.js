...
- При отключении вы будете получать подарок на день рождения, однако вы не будете получать роль <@&983441364903665714> и сообщение в чате для поздравлений!`)
                ...
                case `profile_view`: {
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .setColor(Number(linksInfo.bot_color))
                        .setDescription(`Позволяет или запрещает другим пользователям просматривать ваш </profile info:1055546254609879095>.
### Примечания
- Офицеры и выше по-прежнему смогут просматривать ваш профиль.`)
                ...
                case `marks_view`: {
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .setColor(Number(linksInfo.bot_color))
                        .setDescription(`Позволяет или запрещает другим пользователям просматривать ваш </marks check:1055546254609879095>.
### Примечания
- Офицеры и выше по-прежнему смогут просматривать ваши значки.`)
                ...
                case `is_in_leaderboard`: {
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .setColor(Number(linksInfo.bot_color))
                        .setDescription(`Изменяет отображение вас в списках лидеров в </leaderboard:1055546254186254425>.
### Примечания
